...
- name: scope
  ...
  required: false
  default: all
  description: Census scope to run.
  example: all
...
- name: apply
  ...
  required: false
  default: 'false'
  description: Execute optional write actions. Defaults to false. This implementation keeps revoke_stale disabled.
  example: 'false'
- name: format
  param_type: string
  required: false
...
- name: demo
  ...
  required: false
  default: 'false'
  description: Use deterministic repository fixtures instead of the real local home/workspace.
  example: 'false'
steps:
  harness_inventory:
    type: process.exec
